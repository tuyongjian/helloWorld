 ...
 * generated in the com.tu.webservice.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://service.webservice.tu.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://service.webservice.tu.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.tu.webservice.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.webservice.tu.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.webservice.tu.com/", name = "queryWeather")
